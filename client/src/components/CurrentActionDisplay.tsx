    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          />
          {/* Awaiting action - Minimal display to not block board */}
          {actionType === 'awaiting-action' && onRollDice && (
            <div className="text-center space-y-2 relative z-10 opacity-0 pointer-events-none">
              {/* Hidden - Roll dice button is in right sidebar */}
            </div>
          )}
