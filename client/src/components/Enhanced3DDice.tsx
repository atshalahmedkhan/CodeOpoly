  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="w-full bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-600 hover:from-emerald-600 hover:via-green-600 hover:to-emerald-700 text-white py-4 sm:py-5 rounded-2xl font-black text-lg sm:text-xl transition-all transform shadow-2xl mb-4 sm:mb-6 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2 sm:gap-3 relative overflow-hidden"
        animate={!disabled && !isRolling ? {
          boxShadow: [
            "0 10px 40px rgba(16, 185, 129, 0.5), 0 0 60px rgba(16, 185, 129, 0.3), inset 0 1px 2px rgba(255,255,255,0.3)",
            "0 10px 50px rgba(16, 185, 129, 0.8), 0 0 80px rgba(16, 185, 129, 0.5), inset 0 1px 2px rgba(255,255,255,0.3)",
            "0 10px 40px rgba(16, 185, 129, 0.5), 0 0 60px rgba(16, 185, 129, 0.3), inset 0 1px 2px rgba(255,255,255,0.3)"
          ]
        } : {
          boxShadow: "0 10px 40px rgba(16, 185, 129, 0.3), inset 0 1px 2px rgba(255,255,255,0.2)"
        }}
        transition={{
          duration: 2,
          repeat: !disabled && !isRolling ? Infinity : 0,
          ease: "easeInOut"
        }}
      >
        ...
        />
        <span className="text-2xl sm:text-3xl relative z-10">{isRolling ? '🎲' : '🎲'}</span>
        <span className="relative z-10 text-base sm:text-lg md:text-xl">{isRolling ? 'ROLLING...' : 'ROLL DICE'}</span>
      </motion.button>
      ...
      {!isRolling && dice1 + dice2 > 0 && (
        ...
        >
          {/* Prominent animated result display */}
          <motion.div
          ...
          {dice1 === dice2 && (
            <motion.div
              ...
              className="text-yellow-400 font-bold text-xl sm:text-2xl mt-2"
              animate={{
                scale: [1, 1.15, 1],
              }}
              transition={{
